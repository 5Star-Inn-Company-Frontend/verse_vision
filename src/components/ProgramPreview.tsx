...
export default function ProgramPreview({ className, style, hideHeader }: { className?: string; style?: React.CSSProperties; hideHeader?: boolean }) {
  const { cameras, primaryCameraId, currentScripture, loadCurrent, translationStyle, translationEnabledYoruba, translationEnabledHausa, translationEnabledIgbo, translationEnabledFrench, translations, fetchTranslations, translationEngine, activeAudioCameraId, showScriptureOverlay, showLyricsOverlay, currentSongId, currentLineIndex, loadCurrentLyric, recordingEnabled, countdownEndAt, activePlaylistItem, activePlaylistItemPage, liveStreams, loadCameras, overlayBackgroundColor, overlayTextScale, overlayFontFamily, loadSettings } = useOperatorStore()
